...
<?php 
	if(isset($_GET['pesan'])){
		if($_GET['pesan']=="input"){
			...
			echo "<script>alert('pesanan terkonfirmasi ');</script>";
		}
	}
	?>
...
?>
    <div class="d-flex" id="wrapper">
            ...
            <div class="container-fluid px-4">
                <div class="row my-5">
                    <h3 class="fs-4 mb-3">Data Pesanan</h3>
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-primary" href="zkonfir_pesan.php?id_pesan=<?php echo $d['id_pesan'];?>">konfirm</a></td>
                                </tr>
                            <?php } ?>    
                            </tbody>
                        </table>
